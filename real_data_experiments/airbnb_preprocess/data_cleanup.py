...
reviews = pd.read_csv(reviews_filename) #, names = ['listing_id', 'comments'])       if names were provided, the first row is duplicated
# print(data.info)
# print(list(data))
# print(list(data)[43])
# print(list(data)[87])
...
#print(data[['country', 'street', 'neighbourhood', 'zipcode', 'host_location', 'country_code', 'jurisdiction_names', 'host_location', 'host_neighbourhood']])
